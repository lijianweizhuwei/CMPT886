...
define i32 @signmaskd(<2 x double> %a) #0 {
  %bits = bitcast <2 x double> %a to <2 x i64>
  %b = icmp slt <2 x i64> %bits, zeroinitializer
  %1 = extractelement <2 x i1> %b, i64 0
  %2 = zext i1 %1 to i8
  %3 = extractelement <2 x i1> %b, i64 1
  %4 = zext i1 %3 to i8
  %5 = shl i8 %4, 1
  %6 = or i8 %2, %5
  %7 = trunc i8 %6 to i2
  %result = zext i2 %7 to i32
  ret i32 %result
}
...
define i32 @main(i32 %argc, i8** nocapture readnone %argv) #1 {
  ...
  %13 = tail call i32 @signmaskd(<2 x double> %12) #4
  %14 = and i32 %13, 255
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_Z14print_registerIDv2_xEvPKcT_(i8* %var_name, <2 x i64> %v) #1 comdat {
